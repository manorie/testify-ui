...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationBar = __webpack_require__(/*! ./components/NavigationBar.jsx */ 159);
	
	var _NavigationBar2 = _interopRequireDefault(_NavigationBar);
	
	var _PageHeader = __webpack_require__(/*! ./components/PageHeader.jsx */ 160);
	
	var _PageHeader2 = _interopRequireDefault(_PageHeader);
	
	var _ErrorPane = __webpack_require__(/*! ./components/ErrorPane.jsx */ 161);
	
	var _ErrorPane2 = _interopRequireDefault(_ErrorPane);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var errorData = [{ message: 'You should pick question size' }, { message: 'E-mail cant be blank' }];
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_NavigationBar2.default, { activePath: '/' }),
				_react2.default.createElement(_PageHeader2.default, { header: 'Create Test', info: 'Step 1' }),
				_react2.default.createElement(_ErrorPane2.default, { data: errorData })
			);
		}
	});
...
/* 159 */
/*!*****************************************************!*\
  !*** ./src/client/app/components/NavigationBar.jsx ***!
  \*****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
		...
		getInitialState: function getInitialState() {
			return {
				baseLinks: [{ name: 'Home', path: '/' }, { name: 'Solve Test', path: '/solve/test' }, { name: 'Create Test', path: '/create/test' }]
			};
		},
		...
		render: function render() {
			...
			var linkLines = this.state.baseLinks.map(function (link) {
				return _react2.default.createElement(
					'li',
					{ key: link.name, className: self.props.activePath === link.path ? 'active' : '' },
...
/* 161 */
/*!*************************************************!*\
  !*** ./src/client/app/components/ErrorPane.jsx ***!
  \*************************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    ...
	    if (errorLines.length > 0 && !this.state.hideErrors) {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "col-md-10 col-md-offset-1 text-danger bbottom" },
	          _react2.default.createElement(
	            "div",
	            { className: "col-md-6" },
	            _react2.default.createElement(
	              "h5",
	              null,
	              _react2.default.createElement("i", { className: "fa fa-warning fa-fw mr1" }),
	              "Errors"
	            )
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "col-md-6 text-right text-muted" },
	            _react2.default.createElement(
	              "p",
	              { className: "mt1" },
	              _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "div",
	            { className: "col-md-12" },
	            _react2.default.createElement("hr", { className: "mt0" })
	          ),
	          _react2.default.createElement(
	            "div",
	            { className: "col-md-12" },
